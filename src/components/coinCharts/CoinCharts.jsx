...
/**
 * react component given the chart of a specific coin values in time
 * @param {PropTypes} coinId coin id
 * @param {PropTypes} coinName coin name
 * @returns {React.ReactElement} CoinCharts
 */
const CoinCharts = ({ coinId, coinName }) => {
  ...
  return (
    <div className="coin-chart">
        ...
        {headerData.map((element) => {
          return (
            <div
              ...
              className={element[0] === duration ? 'active-btn' : ''}
            >
              {element[1]}
            </div>
          );
      ...
      <AreaChart
        ...
        height={250}
        data={coinData}
        margin={{ tor: 10, right: 0, left: 100, bottom: 0 }}
      >
        <defs>
